...
public class SanduicheLanchonetCGFactory extends SanduicheFactory {
    @Override
    public SanduicheImpl montarSanduice() {
        return new SanduicheImpl(Pao.INTEGRAL, Queijo.PRATO, Presunto.FRANGO, Salada.SEM_VERDURA);
    }
}
